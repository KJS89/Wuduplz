...
const AddRequest = ({ navigation }) => {
  ...
  <View style={{flex: 1, alignItems: 'center', justifyContent: 'center',alignSelf: 'stretch'}}> 
    ...
    <Text style={styles.text}> Are you over 18 years old? </Text>
    

    <TouchableOpacity activeOpacity={0.5}>
          <View style={styles.GPSbottonON}>
            <Text style={styles.GPSbottonTxt}>Yes</Text>
          </View>
    </TouchableOpacity>
    ...
    <TouchableOpacity activeOpacity={0.5}>
          <View style={styles.GPSbottonON}>
            <Text style={styles.GPSbottonTxt}>No</Text>
          </View>
    </TouchableOpacity>

    <TextInput style={styles.subTextinStyle} placeholder={'Type your year of birth'} underlineColorAndroid={'transparent'} keyboardType={'numeric'} />
    </View>
