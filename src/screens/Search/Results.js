...
const Results = ({navigation}) => {
    ...
    const SearchAPIData = [
        endpoint => '/api/videoRecommendation/search?q={query}', // up to you how you want to structure this
        results => [ // same data but without categories
            {
                requestId: 1,
                requestedByUser: 1,
                video_id: 1,
                videoLocation: 'URL for file' || 'File path on disk', // storage decision
                creator: {
                    id: 1,
                    username: '@some_user_name',
                    imageUri: 'URL for file' || 'File path on disk', // storage decision
                },
                description: 'Description of content',
                likes: 31,
                comments: 12,
                keywords: ['skiing', 'adventure', 'palm-trees'], // not sure how this will be gathered, perhaps at the creation of the request
                private: false, // cannot return private results to a Search page unless requestedByUser == current_user_id
            },
            {
                requestId: 2,
                requestedByUser: 41,
                ...
                likes: 331,
                comments: 112,
                keywords: ['skiing', 'adventure', 'palm-trees'],
                private: true, // if requestedByUser == current_user_id then this result can be viewed
            },
        ]
    ]
                            ...
                            <TouchableHighlight key={key} onPress={() => {
                                ...
                                <ImageBackground
                                    ...
                                    <View style={{position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, justifyContent: 'center', alignItems: 'center'}}>
                                        ...
                                        <FontAwesome style={{position:'absolute', bottom:6, right: 45}} name={'heart-o'} size={16} color={'white'}/>
