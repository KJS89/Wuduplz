                                ...
                                {randomize(data[categorie]).map((video, key) => (
                                    <TouchableHighlight key={key} onPress={() => {
                                        ...
                                        <ImageBackground
                                            ...
                                            <View style={{position: 'absolute',right: 3, bottom: 6, flexDirection:'row'}}>
                                                ...
                                                <FontAwesome style={{opacity: 0.8,right:3}} name={'heart'} size={12} color={'white'}/>
                                                <Text style={{ color:'white', fontSize: 10, opacity: 0.8}}>{convertLikes(video.likes)}</Text>
                                            </View>
                                        </ImageBackground>
                                    </TouchableHighlight>
                                ))}
