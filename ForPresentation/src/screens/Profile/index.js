...
const Profile = ({RootStore ,navigation}) => {
	...
	const [Province,setProvince] = useState(RootStore.Province)
	...
	const setParameters = async()=>{
		...
		setProvince(RootStore.Province)
	}
	...
	return (
        ...
        <TextInput style={styles.inputStyle} placeholder={'Nickname shows here'} underlineColorAndroid={'transparent'} keyboardType={'numeric'} value={NickName}/>
        </View>

        <Text>  </Text>
        <View style={{flexDirection:'row', alignItems:'baseline',}}> 
        <Text style={styles.textstyle}> Email: </Text>
        <TextInput style={styles.inputStyle} placeholder={'Email shows here'} underlineColorAndroid={'transparent'} keyboardType={'numeric'} value={Email}/>
        </View>

        <Text>  </Text>
        <View style={{flexDirection:'row', alignItems:'baseline',}}> 
        <Text style={styles.textstyle}> Keywords: </Text>
        <TextInput style={styles.subTextinStyle} placeholder={'Keyword 1'} underlineColorAndroid={'transparent'} keyboardType={'numeric'} value={Keyword1}/>
        <TextInput style={styles.subTextinStyle} placeholder={'Keyword 2'} underlineColorAndroid={'transparent'} keyboardType={'numeric'} value={Keyword2}/>
        <TextInput style={styles.subTextinStyle} placeholder={'Keyword 3'} underlineColorAndroid={'transparent'} keyboardType={'numeric'} value={Keyword3}/>
        </View>
        ...
        <TextInput style={styles.subTextinStyle} placeholder={'City'} underlineColorAndroid={'transparent'} keyboardType={'numeric'} value={City}/>
        <TextInput style={styles.subTextinStyle} placeholder={'Province'} underlineColorAndroid={'transparent'} keyboardType={'numeric'} value={Province}/>
        <TextInput style={styles.subTextinStyle} placeholder={'Country'} underlineColorAndroid={'transparent'} keyboardType={'numeric'} value={Country}/>
        </View>

        <Text>  </Text>
        <View style={{flexDirection:'row', alignItems:'baseline',}}> 
        <Text style={styles.textstyle}> Membership level: </Text>
        <TextInput style={styles.inputStyle} placeholder={'Free/Golden/Diamond'} underlineColorAndroid={'transparent'} keyboardType={'numeric'} value={'free'}/>
        </View>
