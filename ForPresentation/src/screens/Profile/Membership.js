...
class App extends Component{
    ...
    constructor(){
        ...
        this.state = {
            text: '',
            membership:['Diamond','Golden','Free'],
            price:[20,10,0]
        }
    ...
    onSelect(index, value){
        this.setState({
        text: `Selected membership: ${this.state.membership[index]} , Price: $${this.state.price[index]}/month`
        })
    }
    ...
    render(){
        return(
            ...
            <Text style={styles.title}> Please select a membership level </Text>
                ...
                <TouchableOpacity activeOpacity={0.5} onPress={()=>this.props.navigation.navigate('Payment')}>
