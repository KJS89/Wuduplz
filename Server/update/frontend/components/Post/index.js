...
const Post = (props) => {
	...
	const onCommentPress = async() => {
		...
		console.log('comment url is ',`http://[2607:9880:2538:46:40ac:988b:cf34:685a]:3000/front-end/getComment/${post.VideoId}`)
		var result = await axios.get(`http://[2607:9880:2538:46:40ac:988b:cf34:685a]:3000/front-end/getComment/${post.VideoId}`)
	...
	const postComments = async()=>{
		await fetch('http://[2607:9880:2538:46:40ac:988b:cf34:685a]:3000/front-end/comment', {
			method: 'POST',
			headers: {
		...
		var result = await axios.create({
			baseURL:'http://[2607:9880:2538:46:40ac:988b:cf34:685a]:3000/'
						...
						<View style={styles.modalView}>
							...
							<View style={{flex: 1, backgroundColor: '#FFF'}}>
								...
								>
									...
									content={value.content} uri={value.photopath} />
					...
					<View style={styles.rightContainer}>
						<View style={styles.profilePictureContainer}>
							<Image style={styles.profilePicture} 
								   source={{uri: post.creator.imageUri}}		
							/>	
						</View>
